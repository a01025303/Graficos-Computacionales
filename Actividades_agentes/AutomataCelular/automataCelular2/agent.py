# Code used to define agent for automataCell2
...
class Cell(Agent):
    ...
    def __init__(self, pos, model, init_state=DEAD): # dead by default
        ...
        self._nextState = None # next state
    ...
    #update --> steps
    def step(self):
        # Dictionary that defines neighbors on top of current cell
        ...
        # change each agent to next states depending on conditions
