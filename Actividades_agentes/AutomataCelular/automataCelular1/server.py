# Code used to define server for automataCell1
...
from model import AutomataCell1 # import model to use server --> model.py
...
#Create server
server = ModularServer(AutomataCell1, [canvas_element], "Automata Celular 1", {"height": 50, "width": 50, "density": UserSettableParameter("slider", "Cell density", 0.1, 0.01, 0.5, 0.01)})
